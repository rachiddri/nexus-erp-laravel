...
namespace App\Filament\Resources\RetourClients\RelationManagers;
...
class RetourClientLignesRelationManager extends RelationManager
{
    protected static string $relationship = 'retourClientLignes';
